...
export async function seed() {
  ...
  const insertedCategories = await db
    .insert(categories)
    .values([
      { name: "Daily", icon: "馃搮", isDefault: true },
      { name: "Reward", icon: "馃巵", isDefault: true },
      { name: "Energy", icon: "鈿�", isDefault: true },
      { name: "Event", icon: "馃帾", isDefault: true },
      { name: "Tournament", icon: "馃弳", isDefault: true },
      { name: "Other", icon: "馃搶", isDefault: true },
    ])
    .returning();
